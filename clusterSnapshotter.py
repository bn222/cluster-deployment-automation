...
class ClusterSnapshotter:
    ...
    def import_cluster(self, cdaConfig: CdaConfig) -> None:
    ...
    def _import_vm(self, config: NodeConfig, cdaConfig: CdaConfig) -> None:
        lh = host.LocalHost()
        src = config.image_path
        ...
        ClusterDeployer(self._cc, self._ai, [], "", cdaConfig).update_etc_hosts()
