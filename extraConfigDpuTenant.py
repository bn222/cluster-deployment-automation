...
def _ExtraConfigDpuTenant_common(cc: ClustersConfig, cfg: ExtraConfigArgs, futures: Dict[str, Future[None]], *, new_api: bool = False) -> None:
    [f.result() for (_, f) in futures.items()]
    logger.info("Running post config step")
...
def ExtraConfigDpuTenant_NewAPI(cc: ClustersConfig, cfg: ExtraConfigArgs, futures: Dict[str, Future[None]]) -> None:
