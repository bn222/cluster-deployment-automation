...
' &
    ...
    def cleanup_iso_if_needed(self, iso_path: str, *, expected_size: int) -> None:
        imc = self._create_imc_rsh()
        file_size = self._get_file_size(imc, "/mnt/imc/acc-os.iso")
    ...
    def boot_iso_with_redfish(self, iso_path: str) -> None:
        ...
        self.cleanup_iso_if_needed(iso_path, expected_size=expected_size)
